...
function Services() {
  const sections = [
    { id: "career_page1 section1", component: <Services1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Services2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Services3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Services4 />, ref: React.createRef() },
