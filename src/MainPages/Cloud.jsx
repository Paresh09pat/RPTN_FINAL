...
import Cloud4 from "../Components/Cloud/Cloud4";

function Cloud() {
  const sections = [
    { id: "career_page1 section1", component: <Cloud1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Cloud2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Cloud3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Cloud4 />, ref: React.createRef() },
