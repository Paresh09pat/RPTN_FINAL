...
function Cyber() {
  const sections = [
    { id: "career_page1 section1", component: <Cyber1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Cyber2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Cyber3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Cyber4 />, ref: React.createRef() },
    { id: "career_page5 section5", component: <Cyber5 />, ref: React.createRef() },
    { id: "career_page5 lastSection", component: <Cyber6 />, ref: React.createRef() },
