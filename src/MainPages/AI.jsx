...
function AI() {
  const sections = [
    { id: "career_page1 section1", component: <AI1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <AI2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <AI3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <AI4 />, ref: React.createRef() },
