...
function Consulting() {
  const sections = [
    { id: "career_page1 section1", component: <Consulting1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Consulting2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Consulting3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Consulting4 />, ref: React.createRef() },
