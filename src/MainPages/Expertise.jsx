...
function Expertise() {
  const sections = [
    { id: "career_page1 section1", component: <Expertise1 />, ref: React.createRef() },
    { id: "career_page2 section2", component: <Expertise2 />, ref: React.createRef() },
    { id: "career_page3 section3", component: <Expertise3 />, ref: React.createRef() },
    { id: "career_page4 section4", component: <Expertise4 />, ref: React.createRef() },
    { id: "career_page5 section5", component: <Expertise5 />, ref: React.createRef() },
  ];
